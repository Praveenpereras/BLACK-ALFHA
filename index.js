...
console.log("CONNECTING...BLACK ALFHA V-1 WHATSAPP BOT👾");
...
console.log('BLACK ALFHA V-1 WHATSAPP BOT CONNECTED TO WHATSAPP🥏')
...
*⛓JOIN IN MY WHATSAPP GROUP - :* https://whatsapp.com/channel/0029VaiTjMlK5cDLek3bB533
...
if(senderNumber.includes("94762779719")){
if(isReact) return
m.react("👑")
}       
//=====================✓
...
app.get("/", (req, res) => {
res.send("HELLO,BLACK ALFHA V-1 WHATSAPP BOT STARTED✅");
});
